...
export const metadata: Metadata = {
  title: 'Privacy Policy | BigCradle',
      ...
      <main className="relative z-10 font-sans pt-32 pb-20">
        <div className="w-full max-w-4xl mx-auto px-6 md:px-20">
          <div className="flex flex-col justify-center">
            ...
            {/* Page header */}
            <h1 className="text-[#0546D2] capitalize font-bold text-4xl pb-4 text-center font-poppins">
              Privacy Policy
            </h1>
            <p className="text-center text-sm text-[#6B7280] mb-10 font-poppins">
            ...
            <div className="prose prose-blue max-w-none text-[#494949] font-poppins">
              ...
              <p className="mb-8 leading-relaxed">
                Welcome to BigCradle. BigCradle (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) respects your privacy and is
                committed to protecting your personal information. This Privacy Policy explains how we
                collect, use, store, and share information when you use the BigCradle mobile application
                (&quot;App&quot;).
                <br /><br />
              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 leading-relaxed">
                  ...
                  <div>
                    ...
                    <p>
                      BigCradle may collect precise or approximate location data, including background
                      location access, to:
                    </p>
                    <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 leading-relaxed">
                  ...
                  <p>
                    You may request account or data deletion by contacting:<br />
                    Email:{' '}
                    <a
                      href="mailto:management@bigcradle.com"
                      className="text-[#0546D2] font-bold hover:underline"
                    >
                      management@bigcradle.com
                    </a>
                  </p>
                </div>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="leading-relaxed">
                  We implement appropriate technical and organizational safeguards designed to protect
              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 leading-relaxed">
                  <p>
                    BigCradle is not intended for children under the age of 13 (or the minimum legal age in
                    your jurisdiction). We do not knowingly collect personal information from children. If we
                    become aware that a child has provided personal information, we will take steps to remove
                    such data promptly.
                  </p>
                </div>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="leading-relaxed">
                  The App may use third-party services such as analytics, cloud hosting, authentication, or
                  notification providers. These services may collect and process data in accordance with their
              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 leading-relaxed">
                  <p>
                    We may update this Privacy Policy periodically. Changes become effective immediately upon
                    posting the updated version on this page. Continued use of the App after updates
