...
const DecorativeCluster = ({ side }: { side: 'left' | 'right' }) => (
  ...
  >
    <svg width="350" height="390" viewBox="0 0 350 390" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Electricity Spark Animations Overlaid on original shapes */}
      <motion.path
        d="M200 100C200 73.4784 189.464 48.043 170.711 29.2893C151.957 10.5357 126.522 2.00233e-06 100 0C73.4784 -2.00233e-06 48.043 10.5357 29.2893 29.2893C10.5357 48.0429 4.00466e-06 73.4783 0 100L51.4936 100C51.4936 87.1353 56.6041 74.7975 65.7008 65.7008C74.7975 56.604 87.1353 51.4936 100 51.4936C112.865 51.4936 125.203 56.6041 134.299 65.7008C143.396 74.7975 148.506 87.1353 148.506 100H200Z"
      ...
      />
      <motion.path
        d="M150 107C150 133.522 160.536 158.957 179.289 177.711C198.043 196.464 223.478 207 250 207C276.522 207 301.957 196.464 320.711 177.711C339.464 158.957 350 133.522 350 107L298.506 107C298.506 119.865 293.396 132.203 284.299 141.299C275.202 150.396 262.865 155.506 250 155.506C237.135 155.506 224.797 150.396 215.701 141.299C206.604 132.203 201.494 119.865 201.494 107L150 107Z"
        stroke="#1D4ED8" strokeWidth="5" strokeLinecap="round" fill="none"
        style={{ filter: "drop-shadow(0 0 10px rgba(37,99,235,0.9))" }}
        initial={{ pathLength: 0, pathOffset: 0, opacity: 0 }}
        animate={{ pathLength: [0, 0.15, 0], pathOffset: [0, 0.85, 1], opacity: [0, 1, 0] }}
        transition={{ duration: 3.5, repeat: Infinity, ease: "linear", delay: 1 }}
      />
      <motion.path
        d="M200 290C200 316.522 189.464 341.957 170.711 360.711C151.957 379.464 126.522 390 100 390C73.4784 390 48.043 379.464 29.2893 360.711C10.5357 341.957 4.00466e-06 316.522 0 290L51.4936 290C51.4936 302.865 56.6041 315.203 65.7008 324.299C74.7975 333.396 87.1353 338.506 100 338.506C112.865 338.506 125.203 333.396 134.299 324.299C143.396 315.203 148.506 302.865 148.506 290H200Z"
        stroke="#3B82F6" strokeWidth="4" strokeLinecap="round" fill="none"
        style={{ filter: "drop-shadow(0 0 6px rgba(59,130,246,0.8))" }}
        initial={{ pathLength: 0, pathOffset: 0, opacity: 0 }}
        animate={{ pathLength: [0, 0.25, 0], pathOffset: [0, 0.75, 1], opacity: [0, 1, 0] }}
        transition={{ duration: 3.2, repeat: Infinity, ease: "linear", delay: 0.5 }}
      />
      <motion.path
        d="M150 283C150 256.478 160.536 231.043 179.289 212.289C198.043 193.536 223.478 183 250 183C276.522 183 301.957 193.536 320.711 212.289C339.464 231.043 350 256.478 350 283L298.506 283C298.506 270.135 293.396 257.797 284.299 248.701C275.202 239.604 262.865 234.494 250 234.494C237.135 234.494 224.797 239.604 215.701 248.701C206.604 257.797 201.494 270.135 201.494 283H150Z"
